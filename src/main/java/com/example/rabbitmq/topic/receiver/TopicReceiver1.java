...
public class TopicReceiver1 {
    @RabbitListener(bindings = @QueueBinding(
            ...
            key = "topic.receiver"))
    @RabbitHandler
    public void topicProcess1(@Payload User user, @Headers Map<String, Object> headers, Channel channel) throws IOException, InterruptedException {
        //出现错误拒绝消息
        ...
        //模拟业务代码
        Thread.sleep(200);
        System.out.println(user + " topic消息被消费");
        //正确处理业务后进行确认消息(ACK)
